...
class Auth extends CI_Controller
{
    ...
    public function index() //untuk login
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Admin Marketplace Login Page';
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    if ($user['id_role'] == 1) {
                        header('Location: Dashboard_marketplace');
                    } else {
                        echo 'Wrong page ! you must login at admin store page login';
                    }
                } else {
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Admin Marketplace Registration';
            $this->load->view('templates/auth_header', $data);
