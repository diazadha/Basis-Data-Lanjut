                ...
                <div class="card-body">
                    <table class="table table-hover" width="100%" cellspacing="0">
                        <tbody>
                            <tr>
                                <td>
                                    <?php echo anchor('marketplace/toko/' . $brg->id_toko, 'Semua Kategori') ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="active" style="text-decoration: none"> <?= $brg->nama_kategori ?></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row text-center mt-3 mb-3 responsive">
                <?php foreach ($detail as $brg) : ?>
                    <div class="card ml-3 mb-3 text-center" style="width: 13rem; height:21rem;">
                        ...
                        <h5 class="card-header modal-title font-weight-bold text-primary"><a href="<?= base_url('marketplace/detail/' . $brg->id_barang) ?>"> <?php $namatoko = $brg->nama_barang;
