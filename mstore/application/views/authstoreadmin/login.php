                        ...
                        <div class="col-lg">
                            <div class="p-3">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-2 mt-2">Admin Store</h1>
                                    <hr>
                                </div>

                                <?= $this->session->flashdata('message'); ?>
                                <form class="user" method="post" action="<?= base_url('authstoreadmin'); ?>">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?= base_url('authstoreadmin/registration'); ?>">Create an Store!</a>
                                </div>
                            </div>
                        </div>
                    </div>
